                    ...
                    <div className="space-y-6">
                        <div className="bg-white/5 rounded-xl p-4">
                            ...
                            <div className="flex flex-col gap-3">
                                <h5 className="text-base font-semibold">Worst Case</h5>
                        ...
                        <div className="bg-white/5 rounded-xl p-4">
                            ...
                            <div className="flex flex-col gap-3">
                                { (selectedAlgorithm === "merge" || selectedAlgorithm === "quick") && (
                                    <div>
                                        <h5 className="text-base font-semibold">Best Case</h5>
                                        <div
                                            className="bg-cyan-700 text-purple-300 px-4 py-2 rounded-lg text-center font-semibold"
                                            dangerouslySetInnerHTML={{ __html: complexityMap[selectedAlgorithm].time.best }}
                                        >
                                        </div>
                                    </div>
                                )}
                                { (selectedAlgorithm === "merge" || selectedAlgorithm === "quick") && (
                                    <div>
                                        ...
                                        <div
                                            className="bg-cyan-700 text-purple-300 px-4 py-2 rounded-lg text-center font-semibold"
                                            dangerouslySetInnerHTML={{ __html: complexityMap[selectedAlgorithm].time.worst }}
                                        >
                                        </div>
                                    </div>
                                )}
